...
class CartController extends BaseController
{
    ...
    public function paymentMethod()
    {
        ...
        if ($paymentType == 'sale') {
            ...
            $planId = helperGetSession('shop1_selected_membership_plan_id');
            if (empty($planId)) {
                return redirect()->to(langBaseUrl());
            }
            ...
            $data['promotedPlan'] = helperGetSession('shop1_selected_promoted_plan');
    ...
    public function executePayment($dataTransaction, $paymentType, $baseUrl)
    {
        ...
        if ($paymentType == 'sale') {
            ...
            $promotedPlan = helperGetSession('shop1_selected_promoted_plan');
