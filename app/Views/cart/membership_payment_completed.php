        ...
        <div class="row">
            <div class="col-12">
                <div class="page-confirm">
                    ...
                    <?php if(!empty(helperGetSession('shop1_membership_request_type')) && helperGetSession('shop1_membership_request_type') == 'renew'): ?>
...
<?php helperDeleteSession('shop1_selected_membership_plan_id');
