        ...
        <div class="row">
            <div class="col-12">
                <div class="page-confirm">
                    ...
                    <?php if(!empty($transactionNumber)): ?>
                        <p class="p-order-number"><?= trans("transaction_number"); ?><br><?= $transactionNumber; ?></p>
                    <?php endif;
                    if($method != 'gtw'): ?>
                    ...
                    <div class="m-t-45 text-center">
                        ...
                        <a href="<?= generateDashUrl('products');?>" class="btn btn-lg btn-custom"><?= trans("go_back_to_products")?></a>
                    </div>
                </div>
            </div>
        </div>
...
<?php helperDeleteSession('shop1_selected_promoted_plan');
helperDeleteSession('mds_promote_bank_transaction_number');
helperDeleteSession('mds_promoted_transaction_insert_id'); ?>
